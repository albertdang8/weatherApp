...
const sunnySvg = `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const windSvg = `<svg width="15" height="15" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const moistSvg = `<svg width="15" height="15" viewBox="0 0 18 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const weatherSvg = `<svg width="15" height="15" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function isItPronouncedDataOr(data) {
  ...
  objectList.forEach((card, index) => {
    ...
    let hardCard = `<ul>
    <li>${sunnySvg} Temp: ${temp}°F   ${minTemp}° | ${maxTemp}°.</li>
    <li>${weatherSvg} Weather: ${mainWeather} — <span class="smol">${mainDescription}.</li>
    <li>${windSvg} Wind: ${windSpeed}mph with potential gusts of ${gust}.</li>
    <li>${moistSvg} Humidity: ${moistness}% Clouds: ${clouds}%</li>
    </ul>`;
