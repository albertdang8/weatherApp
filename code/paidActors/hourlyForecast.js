    ...
    cardsHtml += `<article class="accordion-panel">
      <input id="accordion-question-${index}" name="accordion" type="radio" />
        <label for="accordion-question-${index}">
          <span class = "cardTitle">${timeString} ${dateString}</span>
